 ...
 */
public class DrbdManageException extends Exception
{
    ...
    public DrbdManageException(String message)
    {
        super(message);
    }

    public DrbdManageException(String message, Throwable cause)
    {
        super(message, cause);
    }

    public DrbdManageException(
        String message,
