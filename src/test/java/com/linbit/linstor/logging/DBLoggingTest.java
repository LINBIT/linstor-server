...
public class DBLoggingTest
{
    ...
    private static final String TEST_LOG_DIR = "build/test-logs/dblogging";
    ...
    public void testDBLogging() throws Exception
    {
        ...
        // self-test - just make sure that we start from an empty error DB and not get error reports from other unit
        // tests mixed in here
        Assert.assertEquals(0, reports.getTotalCount());

        String errId = errReporter.reportError(new NullPointerException());

        reports = errReporter.listReports(false, null, null, Collections.singleton(errId), null, null);
