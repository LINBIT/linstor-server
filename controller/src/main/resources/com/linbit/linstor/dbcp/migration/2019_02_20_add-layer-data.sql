...
(
    ...
    CONSTRAINT FK_LDRD_VD FOREIGN KEY (RESOURCE_NAME, VLM_NR) REFERENCES VOLUME_DEFINITIONS(RESOURCE_NAME, VLM_NR) ON DELETE CASCADE,
    CONSTRAINT UNQ_LDVD_MINOR UNIQUE (VLM_MINOR_NR)
);

CREATE TABLE LAYER_CRYPT_SETUP_VOLUMES
(
    LAYER_RESOURCE_ID INTEGER NOT NULL,
    VLM_NR INTEGER NOT NULL,
...
(
    ...
    CONSTRAINT UNQ_LSVD_ODATA UNIQUE (VLM_ODATA)
);
