...
public interface GenericDbTestConstants
{
    ...
    String TBL_LAYER_CRYPT_SETUP_VOLUMES = "LAYER_CRYPT_SETUP_VOLUMES";
    ...
    String TBL_LAYER_SWORDFISH_VOLUME_DEFINITIONS = "LAYER_SWORDFISH_VOLUME_DEFINITIONS";
    String TBL_SNAPSHOTS             = "SNAPSHOTS";
    String TBL_SNAPSHOT_DEFINITIONS  = "SNAPSHOT_DEFINITIONS";
    String TBL_SNAPSHOT_VOLUMES      = "SNAPSHOT_VOLUMES";
    String TBL_SNAPSHOT_VOLUME_DEFINITIONS = "SNAPSHOT_VOLUME_DEFINITIONS";
    ...
    String TRUNCATE_LAYER_CRYPT_SETUP_VOLUMES = "DELETE FROM " + TBL_LAYER_CRYPT_SETUP_VOLUMES;
    ...
    String TRUNCATE_LAYER_SWORDFISH_VOLUME_DEFINITIONS = "DELETE FROM " + TBL_LAYER_SWORDFISH_VOLUME_DEFINITIONS;
    String TRUNCATE_SNAPSHOTS = "DELETE FROM " + TBL_SNAPSHOTS;
    String TRUNCATE_SNAPSHOT_DEFINITIONS = "DELETE FROM " + TBL_SNAPSHOT_DEFINITIONS;
    String TRUNCATE_SNAPSHOT_VOLUMES      = "DELETE FROM " + TBL_SNAPSHOT_VOLUMES;
    String TRUNCATE_SNAPSHOT_VOLUME_DEFINITIONS = "DELETE FROM " + TBL_SNAPSHOT_VOLUME_DEFINITIONS;
    ...
    {
        TRUNCATE_LAYER_CRYPT_SETUP_VOLUMES,
        ...
        TRUNCATE_LAYER_SWORDFISH_VOLUME_DEFINITIONS,
        TRUNCATE_SNAPSHOTS,
        TRUNCATE_SNAPSHOT_DEFINITIONS,
        TRUNCATE_SNAPSHOT_VOLUMES,
        TRUNCATE_SNAPSHOT_VOLUME_DEFINITIONS,
        TRUNCATE_SNAPSHOTS,
