...
@Singleton
public class SatelliteConnectionDataGenericDbDriver implements SatelliteConnectionDataDatabaseDriver
{
    private static final String TBL_SC = DbConstants.TBL_SATELLITE_CONNECTIONS;

    private static final String SC_UUID = DbConstants.UUID;
    private static final String SC_NODE_NAME = DbConstants.NODE_NAME;
    private static final String SC_NODE_NET_NAME = DbConstants.NODE_NET_NAME;
    private static final String SC_PORT = DbConstants.TCP_PORT;
    private static final String SC_TYPE = DbConstants.INET_TYPE;
    ...
    @Inject
    public SatelliteConnectionDataGenericDbDriver(
